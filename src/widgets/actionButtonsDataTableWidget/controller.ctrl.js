function ActionButtonsDataTableWidgetController($scope, $http, $log, $filter, $injector) {
  ...
  $scope.$watch('[properties.pageSize, properties.filter, properties.params]', resetPaginationAndUpdateResults, true);
